  ...
  return (
    <nav className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto">
      ...
      <div className="flex items-center space-x-4">
        <Link
          href="/login"
          className="text-gray-700 hover:text-gray-900 px-4 py-2 transition cursor-pointer"
        >
          Log in
        </Link>
        <Link
          href="/register"
          className="bg-gradient-to-r from-[#8aa66e] to-[#a8c686] text-white px-5 py-2 rounded-lg hover:opacity-90 transition shadow-md hover:shadow-lg cursor-pointer"
        >
          Sign up free
        </Link>
      </div>
